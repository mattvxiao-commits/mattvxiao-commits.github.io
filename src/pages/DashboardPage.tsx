...
function DashboardGroup({
  ...
  return (
    <section
      className="dashboardReviewGroup"
      data-testid="dashboard-review-group"
      id={id}
...
export default function DashboardPage() {
  ...
  const [dateRange, setDateRange] = useState<DashboardDateRange | undefined>(
    () => buildDashboardDateRange("today"),
  );
  const [rangePreset, setRangePreset] = useState<DashboardRangePreset>("today");
  const [customRange, setCustomRange] = useState<DashboardCustomRangeInput>(
    () => todayCustomRange(),
  );
  const [accountingScope, setAccountingScope] =
    useState<DashboardAccountingScope>("sales");
  ...
  async function refreshDashboard() {
    ...
    try {
      ...
      setData({
        orders,
        orderItems: orderItemsByOrder.flat(),
        products,
        refunds,
      });
  ...
  function selectRangePreset(nextPreset: DashboardRangePreset) {
    ...
    if (nextPreset === "custom") {
      ...
      setDateRange(
        buildDashboardDateRange("custom", new Date(), nextCustomRange),
      );
  ...
  function updateCustomRange(nextCustomRange: DashboardCustomRangeInput) {
    ...
    try {
      ...
      setDateRange(undefined);
      setRangeError(
        customRangeError instanceof Error
          ? customRangeError.message
          : "自定义日期范围无效。",
      );
    }
  }
  ...
  const scopeOptions: Array<{
    value: DashboardAccountingScope;
    label: string;
  }> = [
  ...
  return (
    <section className="dashboardPage" aria-labelledby="dashboard-title">
      <div className="dashboardHeader">
        ...
        <div
          className="dashboardFilterPanel"
          role="group"
          aria-label="仪表盘筛选"
        >
          <div
            className="dashboardFilterRow"
            role="group"
            aria-label="时间范围"
          >
            <div
              className="dashboardRangeSwitch"
              role="group"
              aria-label="日期范围"
            >
          ...
          {rangePreset === "custom" ? (
            <div
              className="dashboardCustomRange"
              role="group"
              aria-label="自定义日期"
            >
              <label>
          ...
          <div
            className="dashboardFilterRow dashboardFilterScopeRow"
            role="group"
            aria-label="统计口径"
          >
            <div
              className="dashboardScopeSwitch"
              role="group"
              aria-label="口径选项"
            >
          ...
          <div className="dashboardGrid">
            ...
            >
              ...
              <div className="dashboardOperationsStrip" aria-label="订单性质">
                ...
                <div>
                  <span>
                    {dashboard.orderNatureSummary.campaignGiftOrderCount}
                  </span>
                  <p>运营赠礼订单</p>
                </div>
              </div>
            ...
            <DashboardGroup
              id="dashboard-sales"
              title="销售表现"
              description="查看收款、销量和 SPU/SKU 表现。"
            >
              <div className="dashboardOperationsStrip" aria-label="出库与客单">
                ...
                <div>
                  <span>
                    {formatMoney(dashboard.operationsSummary.averageOrderValue)}
                  </span>
                  <p>客单价</p>
                </div>
              </div>
              ...
              >
                ...
                {!isLoading &&
                dashboard.paymentMethodRows.every(
              ...
              <section
                className="dashboardSection"
                aria-labelledby="top-selling-sku-title"
              >
                <div className="sectionTitle">
                  <BarChart3 size={21} aria-hidden="true" />
                  <div>
              ...
              <section
                className="dashboardSection"
                aria-labelledby="top-selling-spu-title"
              >
                <div className="sectionTitle">
                  <BarChart3 size={21} aria-hidden="true" />
                  <div>
              ...
              <section
                className="dashboardSection"
                aria-labelledby="top-revenue-spu-title"
              >
                <div className="sectionTitle">
                  <BarChart3 size={21} aria-hidden="true" />
                  <div>
            ...
            <DashboardGroup
              ...
              title="活动成本"
              description="拆分优惠、满赠、运营赠礼和非销售出库。"
            >
              <div className="dashboardOperationsStrip" aria-label="活动效果">
                ...
                <div>
                  <span>
                    {formatMoney(
                      dashboard.promotionSummary.addonDiscountAmount,
                    )}
                  </span>
                  <p>优惠让利</p>
                </div>
                ...
                <div>
                  <span>
                    {dashboard.promotionSummary.giftTriggeredOrderCount}
                  </span>
                  <p>满赠订单</p>
                </div>
              </div>
              ...
              <div
                className="dashboardOperationsStrip dashboardNonSalesBreakdownStrip"
                aria-label="非销售拆分"
              >
                <div>
                  <span>
                    {dashboard.nonSalesBreakdown.tierGiftQuantity} /{" "}
                    {formatMoney(dashboard.nonSalesBreakdown.tierGiftCost)}
                  </span>
                  <p>满赠</p>
                </div>
                <div>
                  <span>
                    {dashboard.nonSalesBreakdown.campaignGiftQuantity} /{" "}
                    {formatMoney(dashboard.nonSalesBreakdown.campaignGiftCost)}
                  </span>
                  <p>运营赠礼</p>
                </div>
                <div>
                  <span>
                    {dashboard.nonSalesBreakdown.manualGiftQuantity} /{" "}
                    {formatMoney(dashboard.nonSalesBreakdown.manualGiftCost)}
                  </span>
                  <p>人工赠送</p>
                </div>
                <div>
                  <span>
                    {dashboard.nonSalesBreakdown.otherNonSalesQuantity} /{" "}
                    {formatMoney(dashboard.nonSalesBreakdown.otherNonSalesCost)}
                  </span>
                  <p>其他出库</p>
                </div>
              </div>
              ...
              <div
                className="dashboardOperationsStrip dashboardActivityCostStrip"
                aria-label="经营成本口径"
              >
                <div>
                  <span>
                    {formatMoney(
                      dashboard.activityCostSummary.discountGiveawayAmount,
                    )}
                  </span>
                  <p>优惠让利</p>
                </div>
                <div>
                  <span>
                    {formatMoney(dashboard.activityCostSummary.salesCost)}
                  </span>
                  <p>销售成本</p>
                </div>
                <div>
                  <span>
                    {formatMoney(
                      dashboard.activityCostSummary.basicGrossProfit,
                    )}
                  </span>
                  <p>基础毛利</p>
                </div>
                <div>
                  <span>
                    {formatPercent(
                      dashboard.activityCostSummary.basicGrossMargin,
                    )}
                  </span>
                  <p>基础毛利率</p>
                </div>
                <div>
                  <span>
                    {formatMoney(
                      dashboard.activityCostSummary.operatingActivityCost,
                    )}
                  </span>
                  <p>运营活动成本</p>
                </div>
                <div>
                  <span>
                    {formatMoney(
                      dashboard.activityCostSummary.activityAdjustedGrossProfit,
                    )}
                  </span>
                  <p>活动后毛利</p>
                </div>
                <div>
                  <span>
                    {formatPercent(
                      dashboard.activityCostSummary.activityAdjustedGrossMargin,
                    )}
                  </span>
                  <p>活动后毛利率</p>
                </div>
                <div>
                  <span>
                    {formatMoney(
                      dashboard.activityCostSummary.nonOperatingOutboundCost,
                    )}
                  </span>
                  <p>非经营出库</p>
                </div>
                <div>
                  <span>
                    {formatMoney(
                      dashboard.activityCostSummary.fullOutboundCost,
                    )}
                  </span>
                  <p>全出库成本</p>
                </div>
              ...
              <section
                className="dashboardSection"
                aria-labelledby="gift-tier-title"
              >
                <div className="sectionTitle">
                  <BarChart3 size={21} aria-hidden="true" />
                  <div>
              ...
              {dashboard.accountingScope !== "sales" ? (
                <section
                  className="dashboardSection"
                  aria-labelledby="non-sales-reason-title"
                >
                  <div className="sectionTitle">
                    <BarChart3 size={21} aria-hidden="true" />
                    <div>
            ...
            <DashboardGroup
              id="dashboard-profit"
              title="毛利分析"
              description="查看成本快照、毛利排行和低毛利商品。"
            >
              <section
                className="dashboardSection dashboardProfitOverview"
                aria-labelledby="profit-overview-title"
              >
                <div className="sectionTitle">
                  <BarChart3 size={21} aria-hidden="true" />
                  <div>
                ...
                <div
                  className="dashboardOperationsStrip dashboardProfitStrip"
                  aria-label="毛利概览指标"
                >
                  <div>
                    <span>
                      {formatMoney(
                        dashboard.profitSummary.revenueWithCostSnapshot,
                      )}
                    </span>
                    <p>销售额（有成本快照）</p>
                  </div>
                  <div>
                    <span>
                      {formatMoney(dashboard.profitSummary.costAmount)}
                    </span>
                    <p>成本</p>
                  </div>
                  <div>
                    <span>
                      {formatMoney(dashboard.profitSummary.grossProfit)}
                    </span>
                    <p>毛利</p>
                  </div>
                  <div>
                    <span>
                      {formatPercent(dashboard.profitSummary.grossMargin)}
                    </span>
                    <p>毛利率</p>
                  </div>
                  <div>
                    <span>
                      {formatMoney(dashboard.profitSummary.giftCostAmount)}
                    </span>
                    <p>赠品成本</p>
                  </div>
                </div>
                ...
                {dashboard.profitSummary.missingCostItemCount > 0 ? (
                  <p className="errorBanner" role="status">
                    当前范围有 {dashboard.profitSummary.missingCostItemCount}{" "}
                    条旧订单明细缺少成本快照，未纳入准确毛利。
                  </p>
                ) : null}
              </section>
              ...
              <section
                className="dashboardSection"
                aria-labelledby="profit-sku-title"
              >
                <div className="sectionTitle">
                  <BarChart3 size={21} aria-hidden="true" />
                  <div>
              ...
              <section
                className="dashboardSection"
                aria-labelledby="profit-spu-title"
              >
                <div className="sectionTitle">
                  <BarChart3 size={21} aria-hidden="true" />
                  <div>
              ...
              <section
                className="dashboardSection"
                aria-labelledby="low-profit-sku-title"
              >
                <div className="sectionTitle">
            ...
            <DashboardGroup
              ...
              title="库存风险"
              description="查看赠品消耗、低库存、售罄和补货建议。"
            >
              <section
                className="dashboardSection"
                aria-labelledby="gift-consumption-title"
              >
                <div className="sectionTitle">
                  <BarChart3 size={21} aria-hidden="true" />
                  <div>
              ...
              <section
                className="dashboardSection"
                aria-labelledby="low-stock-sku-title"
              >
                <div className="sectionTitle">
                  <AlertTriangle size={21} aria-hidden="true" />
                  <div>
                  ...
                  {dashboard.lowStockRows.map((row) => (
                    <article className="dashboardRankRow" key={row.productId}>
                      ...
                      >
                        ...
                        {row.soldQuantity > 0 ? (
                          <strong>剩余 {row.stockRemainingPercent}%</strong>
                        ) : null}
                      </div>
                    </article>
                  ))}
              ...
              <section
                className="dashboardSection"
                aria-labelledby="sold-out-sku-title"
              >
                <div className="sectionTitle">
                  <AlertTriangle size={21} aria-hidden="true" />
                  <div>
              ...
              <section
                className="dashboardSection"
                aria-labelledby="high-risk-sku-title"
              >
                <div className="sectionTitle">
                  <AlertTriangle size={21} aria-hidden="true" />
                  <div>
              ...
              <section
                className="dashboardSection"
                aria-labelledby="slow-moving-sku-title"
              >
                <div className="sectionTitle">
                  <AlertTriangle size={21} aria-hidden="true" />
                  <div>
              ...
              <section
                className="dashboardSection"
                aria-labelledby="restock-suggestions-title"
              >
                <div className="sectionTitle">
                  <AlertTriangle size={21} aria-hidden="true" />
                  <div>
                  ...
                  {dashboard.restockSuggestionRows.map((row) => (
                    <article className="dashboardRankRow" key={row.productId}>
                      ...
                      >
                        <span>建议补货</span>
                        <strong>
                          售出 {row.soldQuantity} / 库存 {row.stockQty} / 剩余{" "}
                          {row.stockRemainingPercent}%
                        </strong>
                      </div>
                    </article>
                  ))}
            ...
            <DashboardGroup
              ...
              title="订单异常"
              description="集中查看作废、退款、备注和赠品异常。"
            >
              <section
                className="dashboardSection"
                aria-labelledby="exception-orders-title"
              >
                <div className="sectionTitle">
                  <AlertTriangle size={21} aria-hidden="true" />
                  <div>
                ...
                <div className="dashboardExceptionList">
                  {dashboard.exceptionRows.map((row) => (
                    <article
                      className="dashboardExceptionRow"
                      key={row.orderId}
                    >
                      <div>
                        <h3>{row.orderNo}</h3>
